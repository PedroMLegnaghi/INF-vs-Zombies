...
Texture2D TEXTURE_LOGO_BACKGROUBND_IMG;
Rectangle TEXTURE_LOGO_BACKGROUBND_IMG_SOURCE_REC;

Texture2D TEXTURE_ABOUT_BACKGROUND_IMG;
Rectangle TEXTURE_ABOUT_BACKGROUND_IMG_SOURCE_REC;
...
Texture2D TEXTURE_SUNFLOWER_IDLE_IMG;

Texture2D TEXTURE_GREEN_PEASHOOTER_IMG;
Texture2D TEXTURE_GREEN_PEASHOOTER_IDLE_IMG;
Texture2D TEXTURE_GREEN_PEASHOOTER_SHOOTING_IMG;
...
{
    // Backgrounds
    TEXTURE_LOGO_BACKGROUBND_IMG = LoadTexture("./resources/sprites/logo.png");
    TEXTURE_LOGO_BACKGROUBND_IMG_SOURCE_REC = (Rectangle){0, 0, TEXTURE_LOGO_BACKGROUBND_IMG.width, TEXTURE_LOGO_BACKGROUBND_IMG.height};

    TEXTURE_ABOUT_BACKGROUND_IMG = LoadTexture("./resources/sprites/about.png");
    TEXTURE_ABOUT_BACKGROUND_IMG_SOURCE_REC = (Rectangle){0, 0, TEXTURE_ABOUT_BACKGROUND_IMG.width, TEXTURE_ABOUT_BACKGROUND_IMG.height};
    ...
    TEXTURE_SUNFLOWER_IDLE_IMG = LoadTexture("./resources/sprites/sunflower_idle.png");

    TEXTURE_GREEN_PEASHOOTER_IMG = LoadTexture("./resources/sprites/peashooter2.png");
    TEXTURE_GREEN_PEASHOOTER_IDLE_IMG = LoadTexture("./resources/sprites/peashooter_idle.png");
    TEXTURE_GREEN_PEASHOOTER_SHOOTING_IMG = LoadTexture("./resources/sprites/peashooter_shooting.png");
...
void UnloadAllTextures(void)
{
    ...
    UnloadTexture(TEXTURE_LOGO_BACKGROUBND_IMG);
    UnloadTexture(TEXTURE_ABOUT_BACKGROUND_IMG);
    ...
    UnloadTexture(TEXTURE_GREEN_PEASHOOTER_IDLE_IMG);
